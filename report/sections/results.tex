...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=\linewidth]{data/hri_data.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=\linewidth]{data/age_data.png}
    \caption{Age distribution of~the~participants.}\label{fig:age-data}
\end{figure}

\begin{figure}[!ht]
    \centering
    \includegraphics[width=\linewidth]{data/gender_data.png}
    \caption{Gender distribution of~the~participants.}\label{fig:gender-data}
\end{figure}

\begin{figure}[!ht]
    \centering
    \includegraphics[width=\linewidth]{data/previous_experience_data.png}
