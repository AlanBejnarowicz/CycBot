...
\textbf{Hypothesis H1:} Participants will more likely rate well the robot's 
emotions that involve ear movements (happy, sad) compared to emotions that involve only head movements (interested, annoyed).
\textbf{Measure:}  Likert scale ranging from 1 (Very poor) to 5 (Very good). 
\textbf{Analysis:} ANOVA test to compare mean ratings for different emotions.